"""Ventana principal con sidebar + stacked content (session-aware) — CON NUEVOS MÓDULOS.

Reemplaza completamente a views/main_window.py.

Cambios vs original:
- Se registraron los 3 nuevos módulos (clientes, costos, asistente)
- Se agregaron los imports correspondientes
"""
...
from views.costos_view import CostosView
from views.asistente_view import AsistenteView
