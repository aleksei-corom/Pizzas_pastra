...
class ModernMessageBox(QDialog):
    """Dialogo moderno frameless con estilos del tema activo."""

    # Colores por tipo (usados solo para el icono, no para fondos)
    TYPES = {
        'info':     {'color': '#3b82f6', 'bg_alpha': 0.10},
        'success':  {'color': '#22c55e', 'bg_alpha': 0.10},
        'warning':  {'color': '#f59e0b', 'bg_alpha': 0.10},
        'error':    {'color': '#ef4444', 'bg_alpha': 0.10},
        'question': {'color': '#8b5cf6', 'bg_alpha': 0.10},
    }
    ...
    def _apply_styles(self):
        ...
        self.setStyleSheet(f"""
            ...
            #msgTitle {{
                font-size: 16px; font-weight: 700; color: {fg};
            }}
            #msgBody {{
                font-size: 13px; color: {fg_muted}; line-height: 1.5;
            }}
            #msgSep {{
            ...
            QPushButton[class="secondary"] {{
                ...
                border: 1.5px solid {border}; border-radius: 8px; font-weight: 600;
            }}
